<template>
    <div class="signinPage grid justify-center items-center">
                ...
                <div class="relative px-4 py-10 bg-black mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                    <div class="max-w-md mx-auto text-white">
                        ...
                        <div class="text-right mb-4">
                            <a class="text-xs font-display font-semibold text-gray-500 hover:text-gray-400 cursor-pointer"
                                href="#">
                                Forgot Password?
                            </a>
                        </div>
                                ...
                                <button
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25"
                                        ...
                                        <path
                                            ...
                                            opacity=".1"></path>
                                        <polygon points="12,14.25 12,14.5 18.4862061,14.5 18.587492,14.25" opacity=".1">
                                        </polygon>
                                        <path fill="#E6E6E6"
                                        ...
                                        <path fill="#FFF"
                                            ...
                                            opacity=".2"></path>
                                        <linearGradient id="LxT-gk5MfRc1Gl_4XsNKba_xoyhGXWmHnqX_gr1" x1="0" x2="24" y1="12"
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <NuxtLink to="/registration" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign
                                up</NuxtLink>
                            <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
                        </div>
                    </div>
